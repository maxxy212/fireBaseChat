...
public class AccountSettings extends AppCompatActivity {
  ...
  //  private static final int GALLERY_PICK =1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayImage = (CircleImageView) findViewById(R.id.account_image);
        mName = (TextView)findViewById(R.id.account_name);
        mStatus = (TextView)findViewById(R.id.account_status);
        cStatus = (Button)findViewById(R.id.btn_change_status);
        cImage = (Button)findViewById(R.id.btn_change_img);
        mProfileImageReference = FirebaseStorage.getInstance().getReference();
        ...
        muserData.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                   // Picasso.with(AccountSettings.this).load(image).placeholder(R.mipmap.avatar).into(mDisplayImage);
                    Picasso.with(AccountSettings.this).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                            .placeholder(R.mipmap.avatar).into(mDisplayImage, new Callback() {
                        @Override
       ...
       // super.onActivityResult(requestCode, resultCode, data);
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                mProgressDialog.setTitle("Changing display image...");
                mProgressDialog.setMessage("Please wait while we change image");
                ...
                final StorageReference thumb_filepath = mProfileImageReference.child("profile_images").child("thumbs")
                            .child(current_user_id + ".jpg");

                StorageReference filepath = mProfileImageReference.child("profile_images").child(current_user_id + ".jpg");
                    ...
                    filepath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                                ...
                                uploadTask.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                                        ...
                                        if (task.isSuccessful())
                                        {
                                            ...
                                            muserData.updateChildren(update_hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    ...
                                                    if (task.isSuccessful())
                                                    {
                                                        ...
                                                        Toast.makeText(AccountSettings.this, "Success Uploading"
                                        ...
                                        {
                                            Toast.makeText(AccountSettings.this, "Error in uploading thumbnail",
                                                    Toast.LENGTH_LONG).show();
                                            mProgressDialog.dismiss();
                                        }
                                    }
                            ...
                            {
                                Toast.makeText(AccountSettings.this, "Error in uploading",
                                        Toast.LENGTH_LONG).show();
                                mProgressDialog.dismiss();
                            }
                        }
