    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msavebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //progress
                mprogrees = new ProgressDialog(StatusActivity.this);
                mprogrees.setTitle("Saving Status");
                mprogrees.setMessage("Please wait while we save the changes");
                mprogrees.show();
                ...
                mStatusDatabase.child("status").setValue(status).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            Toast.makeText(getApplicationContext(), "Error: Couldn't change status"
